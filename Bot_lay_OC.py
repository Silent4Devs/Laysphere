...
if __name__ == "__main__":
    ...
    with st.sidebar:
        ...
        uploaded_file = st.file_uploader('Upload a file:', type = ['pdf', 'docx', 'txt', 'pptx'])
    ...
    if q:
        if 'vs' in st.session_state:
            ...
            st.write(f'k: {k}')
            result, st.session_state.chat_history = ask_with_memory(vector_store, q, st.session_state.chat_history)
